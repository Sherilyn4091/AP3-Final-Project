...
<main class="lg:ml-64 min-h-screen bg-light-gray">
    ...
    <header class="bg-white shadow-sm p-6 border-b-4 border-secondary-blue">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h1 class="text-3xl font-bold text-primary-dark">Genre management</h1>
    ...
    <div class="p-4 lg:p-6">
        ...
        <div class="card p-6 mb-6">
            <form method="GET" action="{{ route('admin.genres.index') }}" class="flex flex-wrap gap-4">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-primary-dark">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-bold text-accent-yellow uppercase tracking-wider">Genre</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-accent-yellow uppercase tracking-wider">Description</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-accent-yellow uppercase tracking-wider">Students (view)</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-accent-yellow-light transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($genre->student_count > 0)
                                    <button onclick="viewStudents({{ $genre->genre_id }})" class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-secondary-blue text-white hover:bg-secondary-blue-dark transition-all">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold {{ $genre->is_active ? 'bg-forest-green text-white' : 'bg-gray-400 text-white' }}">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p class="text-lg font-semibold">No genres found</p>
