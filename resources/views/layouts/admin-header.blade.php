...
{{-- 
    ...
    Fixed layout with proper positioning and responsive design
    ============================================================================
--}}

<!-- Sidebar for Desktop & Mobile -->
<aside class="fixed top-0 left-0 h-full w-64 bg-primary-dark text-accent-yellow overflow-y-auto transition-transform duration-300 ease-in-out -translate-x-full lg:translate-x-0 z-50 scrollbar-custom" id="admin-sidebar">
    
    {{-- Logo Section --}}
    <div class="p-6 flex items-center justify-center border-b border-secondary-blue">
    ...
    <nav class="mt-4 pb-24">
        <ul class="space-y-1 px-3">
            ...
            <li>
                ...
                <ul class="hidden mt-1 ml-4 space-y-1 border-l-2 border-secondary-blue pl-4">
    ...
    <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-secondary-blue bg-primary-dark">
