{{-- ============================================================================ --}}
{{-- FILE: resources/views/auth/register/sales-staff.blade.php --}}
{{-- SALES STAFF REGISTRATION FORM --}}
{{-- ============================================================================ --}}
...
<head>
    ...
    <title>Sales Staff Registration - Music Lab</title>
...
<body class="bg-light-gray min-h-screen py-8 px-4">
    ...
    <div class="max-w-5xl mx-auto">
        <div class="text-center mb-10 animate-fade-in">
            ...
            <h1 class="text-3xl font-bold text-primary-dark mt-6">Sales Staff Registration</h1>
            <p class="text-secondary-blue mt-2 text-sm">Join our team and help students find their perfect lessons</p>
        </div>

        <div class="card relative overflow-hidden py-8 px-8">
            <form method="POST" action="{{ route('register.sales.process') }}" id="salesStaffForm">
                @csrf
                ...
                <div id="step3" class="step-panel hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="position" name="position" value="{{ old('position') }}" required class="input-field text-sm capitalize-words" placeholder="e.g., Sales Associate">
                        </div>
                        <div class="md:col-span-2">
