{{-- 
  ...
  Uses Essentia.js / fallback pitch detection in AudioWorklet
--}}
        ...
        <header class="mb-8 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-[#44576D] sm:text-base" style="font-family: 'Inter', sans-serif;">
                    Real-time pitch extraction for monophonic audio analysis.
                </p>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5">
                    ...
                    <div class="rounded-[20px] border border-[#D8DDD8] bg-[#FCFCFA] p-4">
                        ...
                        <div class="mt-3 grid grid-cols-1 gap-2">
                            <button id="btnStart"
                                    type="button"
                                    class="rounded-2xl bg-[#223030] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#29353C]"
                                    style="font-family: 'Inter', sans-serif;">
                                Start
                            </button>
                            ...
                            <button id="btnStop"
                                    type="button"
                                    disabled
                                    class="rounded-2xl border border-[#D8DDD8] bg-white px-4 py-2.5 text-sm font-semibold text-[#223030] transition hover:border-[#768A96] hover:bg-[#F4F5F2] disabled:opacity-50"
                                    style="font-family: 'Inter', sans-serif;">
                                Stop
                            </button>
                            ...
                            <button id="btnReset"
                                    type="button"
                                    class="rounded-2xl border border-[#D8DDD8] bg-white px-4 py-2.5 text-sm font-semibold text-[#223030] transition hover:border-[#768A96] hover:bg-[#F4F5F2]"
                                    style="font-family: 'Inter', sans-serif;">
                                Reset
                            </button>
                        </div>
