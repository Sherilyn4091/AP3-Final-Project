...
// database/migrations/2025_12_26_034857_create_payments_table.php
    ...
    public function up(): void
    {
        if (!Schema::hasTable('payment')) {
            Schema::create('payment', function (Blueprint $table) {
                ...
                $table->foreignId('payment_method_id')->constrained('payment_methods', 'method_id')->onDelete('restrict');
