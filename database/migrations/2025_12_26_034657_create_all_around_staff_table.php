...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('all_around_staff')) {
        Schema::create('all_around_staff', function (Blueprint $table) {
            $table->id('all_around_staff_id');
            ...
            $table->text('primary_duties')->nullable();
    ...
    {
        Schema::dropIfExists('all_around_staff');
    }
};